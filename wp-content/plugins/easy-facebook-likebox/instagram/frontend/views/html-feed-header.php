						...
						if ( $mif_values['show_no_of_followers'] ) { ?>
                            ...
                            <div class="esf_insta_followers"
                                ...
                                <i class="icon icon-esf-user"
                                   aria-hidden="true"></i><?php echo esf_insta_readable_count( apply_filters( 'esf_insta_feed_header_followers', $esf_insta_user_data->followers_count, $esf_insta_user_data ) ); ?>
